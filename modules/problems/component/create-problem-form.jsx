...
const sampledpData = {
  ...
  hints: "Add the two numbers together.",
  editorial:
    "This is a simple addition problem. Take two inputs and return their sum.",
  testCases: [
    { input: "3 5", output: "8" },
    { input: "-2 7", output: "5" },
    { input: "0 0", output: "0" },
...
class Main {
  ...
  public static void main(String[] args) {
      ...
      Main main = new Main();
      int result = main.sumTwoNumbers(a, b);
